...
public partial class Grid : Node2D
{
    ...
    public override void _Draw()
    {
        ...
        {
            Vector2 a = tileMapLayer.ToGlobal(tileMapLayer.MapToLocal(new Vector2I(x, startCell.Y)) - halfTile);

            Vector2 b = tileMapLayer.ToGlobal(tileMapLayer.MapToLocal(new Vector2I(x, endCell.Y + 1)) - halfTile);
        ...
        {
            Vector2 a = tileMapLayer.ToGlobal(tileMapLayer.MapToLocal(new Vector2I(startCell.X, y)) - halfTile);

            Vector2 b = tileMapLayer.ToGlobal(tileMapLayer.MapToLocal(new Vector2I(endCell.X + 1, y)) - halfTile);
